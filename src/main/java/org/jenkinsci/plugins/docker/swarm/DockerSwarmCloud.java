...
public class DockerSwarmCloud extends Cloud {
    ...
    public DockerSwarmCloud(DockerServerEndpoint dockerHost, String jenkinsUrl,
                            String swarmNetwork, String cacheDriverName, List<DockerSwarmAgentTemplate> agentTemplates) {
